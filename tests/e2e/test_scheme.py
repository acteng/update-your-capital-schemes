...
def test_scheme(api: bool, app_client: AppClient, api_client: ApiClient, oidc_client: OidcClient, page: Page) -> None:
        ...
        api_client.add_schemes(
            build_capital_scheme_model(
                ...
                authority_review=CapitalSchemeAuthorityReviewModel(
                    review_date="2023-01-02T00:00:00Z", source="ATF4 bid"
                ),
            )
        )
    else:
