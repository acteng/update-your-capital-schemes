...
class TestSchemeMilestones:
    ...
    def test_scheme_shows_development_milestones(self, schemes: SchemeRepository, client: FlaskClient) -> None:
        scheme = build_scheme(
            id_=1, reference="ATE00001", type_=SchemeType.DEVELOPMENT, name="Wirral Package", authority_id=1
        )
    ...
    def test_scheme_shows_construction_milestones(self, schemes: SchemeRepository, client: FlaskClient) -> None:
        scheme = build_scheme(
            id_=1, reference="ATE00001", type_=SchemeType.CONSTRUCTION, name="Wirral Package", authority_id=1
        )
        scheme.milestones.update_milestones(
            MilestoneRevision(
                1,
