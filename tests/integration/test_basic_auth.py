...
class TestBasicAuthWhenPublic:
    def test_can_access(self, client: FlaskClient) -> None:
        response = client.get("/")
...
class TestBasicAuthWhenProtected:
    ...
    def test_cannot_access_when_incorrect_credentials(self, client: FlaskClient) -> None:
