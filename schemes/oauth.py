...
class _AccessTokenParamsFlaskAsyncOAuth2App(AsyncOAuth2Mixin, AsyncOpenIDMixin, AsyncBaseApp):  # type: ignore
...
class OAuthExtension(OAuth):  # type: ignore
    def __init__(self, app: Flask):
        ...
        if "ATE_URL" in app.config:
            ...
            self.register(
                name="ate",
                client_cls=_AccessTokenParamsFlaskAsyncOAuth2App,
